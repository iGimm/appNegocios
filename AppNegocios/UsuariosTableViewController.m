...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    Usuario *usuarioSeleccionado = [_fetchedResultsController objectAtIndexPath:indexPath];
    NSLog(@"%@",[[[[usuarioSeleccionado categories] allObjects] firstObject] nombreCategoria]);
